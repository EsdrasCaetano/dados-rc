  ...
  useEffect(() => {
    const processCSV = async () => {
      try {
        ...
        const filteredData = parsedData.filter(row => row['en_banheiros'] !== undefined && row['en_banheiros'] !== '' && parseInt(row['en_banheiros']) !== 0);
