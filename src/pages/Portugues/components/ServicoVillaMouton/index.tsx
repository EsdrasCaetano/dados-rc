    ...
    const processCSV = async () => {
      try {
        ...
        const columnsToDisplay = [
          { dataKey: 'central_atendimento_suporte', name: 'Central de atendimento (suporte)' },
          { dataKey: 'bilheteria_suporte', name: 'Bilheteria (suporte)' },
          { dataKey: 'carneiros_store', name: 'Carneiros Store' },
          { dataKey: 'varanda_burger_alimentacao', name: 'Varanda Burguer (alimentação)' },
          { dataKey: 'the_poke_alimentacao', name: 'The Poke (alimentação)' },
          { dataKey: 'pizza_da_villa_alimentacao', name: 'Pizza da Vila (alimentação)' },
          { dataKey: 'ac_up_alimentacao', name: `Aç'up (alimentação)` },
          { dataKey: 'expresso_mercado_alimentacao', name: 'Expresso Mercado (alimentação)' },
          { dataKey: 'instituto_dr_bernado_guimarares_sb', name: 'Instituto Dr. Bernardo Guimarães (Saúde & Beleza)' },
          { dataKey: 'spa_aua_sb', name: 'Spá AUÁ (Saúde & Beleza)' },
          { dataKey: 'rom_concept_brae_sb', name: 'ROM Concept + Braé (Saúde & Beleza)' },
          { dataKey: 'confraria_barba_sb', name: 'Confraria da Barba (Saúde & Beleza)' },
          { dataKey: 'nenhum_servico', name: 'Nenhum' }
        ];
