  ...
  useEffect(() => {
    const processCSV = async () => {
      try {
        ...
        const filteredData = parsedData.filter(row => row['en_ingresse'] !== undefined && row['en_ingresse'] !== '' && parseInt(row['en_ingresse']) !== 0);
