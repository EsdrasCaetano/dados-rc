...
const categories: Category[] = [
  ...
  },
  {
    ...
    items: [
      'Quality of the food was great, but some diversification would be appreciated, especially during 31/01 something extra would be nice.',
  ...
  },
  {
    name: 'Outros',
    items: [
      'cook it more, we had a raw chicken, raw shrimps',
    ]
  }
];
