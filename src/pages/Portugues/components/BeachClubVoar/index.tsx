  ...
  useEffect(() => {
    const processCSV = async () => {
      try {
        ...
        const filteredData = parsedData.filter(row => row['beach_club_voar'] !== undefined && row['beach_club_voar'] !== '' && parseInt(row['beach_club_voar']) !== 0);
