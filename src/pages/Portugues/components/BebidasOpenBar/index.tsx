  ...
  useEffect(() => {
    const processCSV = async () => {
      try {
        ...
        const filteredData = parsedData.filter(row => row['bebidas_openbar'] !== undefined && row['bebidas_openbar'] !== '' && parseInt(row['bebidas_openbar']) !== 0);
