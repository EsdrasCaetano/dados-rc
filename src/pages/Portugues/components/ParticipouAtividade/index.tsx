    ...
    const processCSV = async () => {
      try {
        ...
        const columnsToDisplay = [
          { dataKey: 'rituaus', name: 'Rituaus' },
          { dataKey: 'yoga', name: 'Yoga' },
          { dataKey: 'mangue_gym', name: 'Mangue Gym' },
          { dataKey: 'treino_funcional', name: 'Treino funcional' },
          { dataKey: 'bike_ride', name: 'Bike Ride' },
          { dataKey: 'water_bike', name: 'Water Bike' },
          { dataKey: 'nenhuma_atividade', name: 'Nenhuma' }
        ];
