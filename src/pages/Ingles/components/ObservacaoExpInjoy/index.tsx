...
const categories: Category[] = [
  ...
  },
  {
    name: 'Negativa',
    items: [
    `Injoy was fine, except for requesting a bunch of extra documents at the last minute.  One issue we had is that they were advertising Hotel Arena as a party-exclusive hotel and it really wasn't...`,
    ]
  }
];
